...
if(check_errors[1] > 0):
    ...
    print("Game successfully intialized")
...
def init_vars():
    ...
    head_pos = [120,60]
    snake_body = [[120,60]]
    food_pos = [random.randrange(1,(frame_size_x // square_size)) * size,
...
def show_score(choice, color, font, size):
    ...
    some_rect = score_surface.get_react()
    if choice == 1:
...
while True:
    ...
    if head_pos[0] == food_pos[0] and head_pos[0] and head_pos[1] == food_pos[1]: 
        score += 1
        food_spawn = False 
    else:
        snake_body.pop()
    ...
    # spam food 
    if not food_spam:
        food_pos = [random.randrange(1,(frane_size_x // square_size)) * square_size, 
            random.randrange(1,(frame_size_y // square_size)) * square_size]
    # GFX
